...
public OnFilterScriptInit()
{
    ...
    db_query(Database,"CREATE TABLE IF NOT EXISTS Members (UserID INTEGER PRIMARY KEY AUTOINCREMENT,UserName VARCHAR(24) COLLATE NOCASE,GangMember TINYINT DEFAULT 0,GangName VARCHAR(24) COLLATE NOCASE,GangLeader TINYINT 0)");
